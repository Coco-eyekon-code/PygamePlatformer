...
screenHeight = 573
screen = pygame.display.set_mode((1100, screenHeight))
...
backgroundSprite2 = pygame.image.load('background2.jpg')
original_width, original_height = backgroundSprite.get_size()
scaledHeight = original_height / original_width * 1100
original_width2, original_height2 = backgroundSprite2.get_size()
scaledHeight2 = original_height2 / original_width2 * 1100
backgroundSprite = pygame.transform.scale(backgroundSprite, (1100, scaledHeight))
backgroundSprite2 = pygame.transform.scale(backgroundSprite2, (1100, scaledHeight2))
platform1 = PlatformSprite('platform1.png', 220, 30, 100, 420, 0.08)
platform2 = PlatformSprite('platform2.png', 220, 30, 270, 260, 0.09)
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
           if event.key == pygame.K_LEFT: 
              ...
              catYSpeed = 0.8
    screen.fill("white")
    screen.blit(backgroundSprite, (0, screenHeight - scaledHeight + screenYShift))
    screen.blit(backgroundSprite2, (0, screenHeight- scaledHeight + screenYShift - scaledHeight))
    landing = False
    ...
    for p in platformList:
        if p.y + screenYShift > 573 + catHeight + 20:
            ...
            p.y = newPlatformY
            p.xSpeed = random.randrange(1,1000)/1000 * 0.6 - 0.3
    catX = catX + catSpeed
